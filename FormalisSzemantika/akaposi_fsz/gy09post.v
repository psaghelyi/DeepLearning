...
Compute unresult (ceval 10000 inf_iter empty) X.
...
exists (X ::= Y). exists 10. intros. reflexivity. Qed.

(* Letezik vegtelen ciklus, ami nem csinal semmit. *)
Lemma l3 : exists (c : cmd), forall s, forall f, ceval f c s = outoffuel s.
