...
- apply eval_skip.
- destruct (beval (X <= Y) s) eqn:H.  (* destruct eredmenyenek megjegyzese *)
  * apply eval_if_true.
    + assumption.
    + apply eval_skip.
  * apply eval_if_false.
...
Proof.
exists (update "X" 2 astate). apply eval_if_true.
- reflexivity.
- apply eval_assign.
Qed.
...
(* FELADAT: irj egy programot, ami a parameter `n`-tol kezdve osszegzi a szamokat 0-ig lefele! *)
