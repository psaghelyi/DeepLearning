...
intros. apply evalb_plus; apply evalb_lit. Qed.

Example ex2 : forall (n : nat)(x : string), 
  plus (var x) (lit n) , empty =v n.
intros. apply evalb_plus with (n1 := 0).
- apply evalb_var.
- apply evalb_lit.
Qed.
