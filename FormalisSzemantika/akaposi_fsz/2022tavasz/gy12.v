...
(* FELADAT: csereld le az "outoffuel s"-t valami masra! *)
    | csimassign x1 x2 a1 a2 => final (update x2 (aeval a2 s) (update x1 (aeval a1 s) s))
    end
 end.
...
| eval_simassign x1 x2 a1 a2 s :
  | csimassign x1 x2 a1 a2, s | -=> update x2 (aeval a2 s) (update x1 (aeval a1 s) s)
...
--- apply eval_skip.
- inversion H; subst.
-- inversion H6; subst. apply eval_while_true with s'; assumption.
